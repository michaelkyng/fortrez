<template>
  <div class="space-y-5 md:space-y-10">
    ...
    <div class="relative flex flex-col gap-2.5 md:gap-5">
      ...
      >
        <div
          class="absolute px-10 py-5 md:px-20 md:py-10 bg-alternativeAccent rounded-3xl container"
        >
          <span
      ...
      <div class="relative group w-full h-52 rounded-2xl overflow-clip z-0">
        ...
        <img
          ...
          :src="blogData.image ? blogData.image : defaultImageHolder"
          alt="Product Image"
        />
      ...
      <UInput
        ...
        type="name"
        class="bg-white-bright rounded-2xl py-1"
        color
      ...
      <div class="flex items-center w-full gap-x-5">
        ...
        <UTextarea
          ...
          class="bg-white-bright rounded-2xl w-full"
          color
          placeholder="Blog Tags (Each Tag should start with a hashtag(#) and separated with a space"
        ></UTextarea>
      </div>
      <div class="flex items-center w-full gap-x-5">
        <select
