  ...
  <div class="relative z-0">
    ...
    <div class="z-10">
      ...
      <div class="px-5 space-y-14 overflow-hidden":class="containerWidth">
        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-x-10 gap-y-14 lg:gap-x-14 xl:gap-x-20">
            <ProjectsItemContentSummaryProblemFrame class="basis-full lg:basis-1/2"
            name="Summary"
            :choice="true"
            :description="project.description"
            :problem="project.problem"
            />
            <ProjectsItemContentStats class="basis-full lg:basis-1/2"
            :percentVerifiedFunded="Math.round((project.verifiedFunded/project.funded)*100)"
        ...
        <!-- Second Row -->
        <div class="flex flex-wrap-reverse lg:flex-nowrap gap-x-10 lg:gap-x-14 xl:gap-x-20 gap-y-14 w-full">

          <ProjectsItemContentSummaryProblemFrame class="basis-full lg:basis-1/2 shrink-0 "
            name="Problems to be Addressed"
            :choice="false"
            :description="project.description"
            :problem="project.problem"
            />
          ...
          <div class="flex flex-col basis-full lg:basis-1/2  w-1/2">
            <ProjectsItemContentRecentTransactions :project="project" />
          </div>
        </div>

          <!-- Solutions -->
        <div class="relative">
          <ProjectsItemContentSolutions :solution="project.solutions"/>
        </div>
        ...
        <div class="flex flex-col gap-y-4">
          <HomeContentOurProjects title="Other Projects" :font="subHeading2" :project="false"/>
...
const project = ref({
        ...
        transactions:[
        {
                ...
                userId: '',
                donor:  "John Doe",
                comment: "Looking forward to seeing the progress,Looking forward to seeing the progress",
                amount: 50000,
                currency: "NGN-Naira",
  ...
  const entries = project.value.transactions.slice((project.value.transactions.length-11),(project.value.transactions.length-1))
</script>