    ...
    <div class="relative pt-20 z-0 px-5">
      ...
      <div class="relative py-14 flex flex-col items-start justify-center gap-y-14" :class="containerWidth">
        ...
        <div v-if="Fdata" class="w-full">
          ...
          <ProjectsItemContentDonation @change="refresh" :project="Fdata" :entries="entries" :full-view="true"/>
          <div class="flex justify-between w-full">
            <ButtonLink :to="`/projects/f/${Fdata.title}`" name="Project Oveview" class="px-2.5">
              <ArrowSmLeftIcon class="w-4 h-4 order-first"/>
            </ButtonLink>
