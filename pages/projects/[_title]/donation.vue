  ...
  <div class="relative pt-20 z-0">
    ...
    <div class="relative py-14 flex flex-col items-start justify-center gap-y-14" :class="containerWidth">
      ...
      <div class="flex flex-wrap-reverse justify-between w-full gap-y-5">
        ...
        <ButtonLink :to="`/projects`" name="All Projects" class="flex flex-col justify-center z-20 ml-auto">
          <ArrowSmLeftIcon class="w-4 h-4 order-first"/>
        </ButtonLink>
      </div>
      <ProjectsItemContentDonation @change="refresh" :project="project" :entries="entries" :full-view="true"/>

      <div class="flex justify-between w-full">
        <ButtonLink :to="`/projects/${project.title}`" name="Project Oveview" class="px-2.5">
          <ArrowSmLeftIcon class="w-4 h-4 order-first"/>
        </ButtonLink>

        <ButtonLink :to="`/projects/${project.title}/donate`" class="px-2.5" name="Donate Now">
